                                    ...
                                    <div class="space-y-6">
                                        <ul class="flex items-center justify-between" v-for="course in $page.ownedCourses">
                                            <li class="flex items-center">
                                                ...
                                                <jet-button v-if="Object.keys(course.positionArray).length > 0"><a :href="route('courses.tasks.show', {'course':course.id, 'task':Object.keys(course.positionArray)[0]})">Ver</a></jet-button></li>
                                        </ul>
                                    </div>
                                </template>
                            </jet-action-section>
